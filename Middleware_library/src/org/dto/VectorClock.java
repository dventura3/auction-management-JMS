...
public class VectorClock extends HashMap<String, Integer> implements Serializable{
        ...
        public void incrementClock(String processId)
        {
                // If we have it in the vector, increment.
                if (this.containsKey(processId)){
                        this.put(processId, this.get(processId).intValue() + 1);
                }
                // Else, store with value 1 (starts at 0, +1).
                else {
                        this.put(processId, 1);
                }
        }

//        public void setClock(String processId, Integer value){
//             if (this.containsKey(processId)){
//                        this.put(processId, value);
//                }
//        }
	...
	public Integer get(Object key){
		Integer lResult = super.get((String)key);
		if (lResult == null)
			lResult = 0;
		return lResult;
	}
